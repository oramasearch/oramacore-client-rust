...
mod tests {
    use super::*;
    use crate::auth::{ApiKeyAuth, AuthConfig};

    #[tokio::test]
    async fn test_client_creation() {
        let auth_config = AuthConfig::ApiKey(
            ApiKeyAuth::new("test-key")
                .with_reader_url("https://reader.example.com")
    ...
    fn test_client_request_builder() {
        ...
        assert_eq!(request.target, Target::Reader);
        assert_eq!(request.api_key_position, ApiKeyPosition::QueryParams);
